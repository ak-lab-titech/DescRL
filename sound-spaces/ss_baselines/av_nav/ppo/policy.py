...
class Policy(nn.Module):
    ...
    def evaluate_actions(
        ...
        return value, action_log_probs, distribution_entropy, rnn_hidden_states, direct_map
...
class AudioNavBaselineNet(Net):
    ...
    def __init__(self, observation_space, hidden_size, goal_sensor_uuid, direct_map_size, action_num, extra_rgb=False):
        ...
        rnn_input_size = (
            ...
            direct_map_size if self.direct_map_size is not None else 0
        )
    ...
    def forward(self, observations, rnn_hidden_states, prev_direct_map, prev_actions, masks):
        x = []
